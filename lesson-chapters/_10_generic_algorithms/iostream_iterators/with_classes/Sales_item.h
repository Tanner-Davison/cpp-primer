 ...
 * association, given proper citation if and when posted or
 * reproduced. Any commercial use of this code requires the explicit written
 * permission of the publisher, Tanner Davison , a division of
 * Send your request for permission, stating clearly
 * what code you would like to use, and in what specific way, to the following
 * address:
 *     The Davison Boys, llc.
 *     227 w thistle dr
 *     Ut, 84045
 *     email: tanner.davison@gmail.com
 */
