...
class TerminalMenu {
 ...
 public:
   TerminalMenu(const std::string& menuTitle, const std::vector<std::string>& menuOptions)
...
int main() {
   // Example usage
   std::vector<std::string> menuOptions = {"View Library", "Add New Book", "Search Books", "Remove Book",
                                           "Exit Program"};
