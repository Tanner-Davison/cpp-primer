...
int main() {
  ...
  std::cout << "print in reverse from a vector using reverse iterators"
            << std::endl;
  ...
  std::cout << "print a vector  in reverse using ordinary iterators:"
            << std::endl;
  while (end != start) {
    end--;
    print = *end;
  ...
  std::cout << "copy elements from position 3-7 into a list in reverse order"
            << std::endl;
