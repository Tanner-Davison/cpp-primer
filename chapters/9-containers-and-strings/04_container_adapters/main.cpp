...
// Covers: stack, queue, priority_queue - specialized interfaces built on other
// containers
...
int main() {
  ...
  std::priority_queue<std::string, std::vector<std::string>,
                      decltype(string_length_compare)>
      string_pq(string_length_compare);
  ...
  std::cout
      << "   Priority Queue: O(log n) insert/remove, uses vector by default\n";
  std::cout << "   All adapters provide restricted interfaces to underlying "
               "containers\n";
