...
// Covers: string manipulation, conversions, string_view, and practical string operations
...
int main() {
    ...
    double pi_value = std::stod(pi_string.substr(pi_string.find_first_of("+-.0123456789")));
    std::cout << "   Original: '" << pi_string << "' -> Extracted double: " << pi_value << std::endl;
    
    // Convert string to int
    int int_value = std::stoi(number_string);
    std::cout << "   String: '" << number_string << "' -> Integer: " << int_value << std::endl;
    
    // Convert string to float
    float float_value = std::stof(float_string);
    std::cout << "   String: '" << float_string << "' -> Float: " << float_value << std::endl;
    ...
    std::string long_string = "This is a very long string that we want to process efficiently";
    ...
    std::cout << "   View empty: " << (view.empty() ? "true" : "false") << std::endl;
    std::cout << "   View starts with 'This': " << (view.starts_with("This") ? "true" : "false") << std::endl;
    std::cout << "   View ends with 'efficiently': " << (view.ends_with("efficiently") ? "true" : "false") << std::endl;
    std::cout << "\n";
    ...
    // Word counting
    std::string paragraph = "The quick brown fox jumps over the lazy dog. The fox is quick and brown.";
    ...
    std::cout << "   - Prefer string literals over string objects for constants\n";
